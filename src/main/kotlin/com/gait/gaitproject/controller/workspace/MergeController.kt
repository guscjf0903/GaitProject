...
class MergeController(
    ...
    fun create(
        ...
        @RequestParam(required = false) initiatedByUserId: UUID?
    ): ResponseEntity<ApiResponse<MergeResponse>> =
        ResponseEntity.ok(ApiResponse.ok(mergeService.create(request.copy(workspaceId = workspaceId), initiatedByUserId)))
}
